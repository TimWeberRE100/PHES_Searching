...
class SearchType {
  public:
    enum type {GREENFIELD, OCEAN, SINGLE_EXISTING, BULK_EXISTING, BULK_PIT, SINGLE_PIT, RIVER, TURKEY};
    ...
    bool grid_cell(){
      return value == GREENFIELD || value == OCEAN || value == BULK_EXISTING || value == BULK_PIT || value == RIVER || value == TURKEY;
    }
    bool single(){
